...
from SE_GUI.models import BirdImage, BirdAudio
...
print("Image Classifier code loaded")
...
def image_predict(request):
    ...
    model_img = load('SE_GUI\\models_ML\\model_128_0.05', 'rb')
...
def audio_predict(request):
    ...
    model_audio = load('SE_GUI\\models_ML\\model_lr_0.01', 'rb')
    print("Audio model is loaded")
    model_audio.cuda()
